...
@Configuration
internal class CustomerSnapshotEventConfiguration {
    ...
    fun customerSnapshotTriggerDefinition(snapshotter: Snapshotter) =
    ...
    fun customerOrderSnapshotTriggerDefinition(snapshotter: Snapshotter) =
